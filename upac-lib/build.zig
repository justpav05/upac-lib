...
pub fn build(b: *std.Build) void {
    ...
    upac_installer.addImport("upac-database", upac_data);
    ...
    upac_uninstaller.addImport("upac-database", upac_data);
    ...
    upac_rollback.addImport("upac-database", upac_data);
    ...
    shared_lib.root_module.addImport("upac-database", upac_data);
